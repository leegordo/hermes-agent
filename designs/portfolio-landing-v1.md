...
|---------|----------|-----------|
| **Background** | `#0c0c10` deep void | Matches the live portfolio site. Darker than pure black, warm undertone. |
| **Accent** | `#e85a8a` pink | Matches the live portfolio site. Warm, distinctive, used sparingly: label, CTA, arrows. |
...
| **Project list** | Horizontal rows, not cards | Cards are AI-template slop. Rows feel editorial — more like a table of contents. Each row is a surface (`#14141c`) with a pink arrow as the affordance. |
...
3. **Motion:** The pink arrow could animate on hover (`→` slides right). The rows could lift slightly. Nothing gratuitous.
